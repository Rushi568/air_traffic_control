    ...
    <head>
        ...
        <script>
            ...
            <%            if (lat != null && lng != null) {
                    ...
                    out.print("center: {lat:" + String.format("%.3f",new Double(lat)) + " , lng:" + String.format("%.3f",new Double(lng)) + " },");
                } else {
            ...
            var lat0, lng0, lat1, lng1;
                    ...
                    type: "GET",
                            ...
                            image = new google.maps.MarkerImage(
                                    ...
                                    // selector+="<option>"+flight[13]+"</option>";
                                    //$( "select" ).add( "<option>"+flight[13]+"</option>" );
                                    if (flight[13] != "" && flight[16] != "")
                                    $("#selectBox").append('<option value="' + flight[13] + '">' + flight[13] + "/" + flight[16] + '</option>');
                            }
                            i++;
                            }
                            //selector+="</select>";
        ...
        <script>
            ...
            $("#flightnumber").val(this.value); // this.value is enough for you

            }).val($('#flightnumber').val()).change(); // for pre-selection trigger
    ...
    <body>
        ...
        <div class="fluid">
            ...
            <nav class="navbar navbar-inverse" style="z-index: 2;">
                <div class="container-fluid">
                            ...
                            <div class="navbar-header">
                                <a class="navbar-brand" href="http://192.168.0.105:8080/AATC/index.jsp"><img src="images/AATCnew.png"/></a>
                            </div>
                        
                        
                            <div class="navbar-header">
                                <h4 style="text-align: left;color: lightblue;"><input type="text" class="form-control" placeholder="Switch To Another Airport" id="search" ></h4>
                            </div>
                 
                      
                            <ul class="nav navbar-nav">
                                <li style=" text-transform: capitalize;"><span id="utc" style="text-transform: uppercase; font-size: 20px; color: gold;"></span></li>
                            </ul>
            ...
            <div class="sidenav">
                ...
                <script>
                            ...
                            $.ajax({url: "send.jsp?iata=" + "<%=iata%>" + "&flightnumber=" + $("#flightnumber").val(),
                ...
                <div class="container-fluid">
                    <h4 style="text-align: center;"><span style="font-size: 13px;">CONTROL FLIGHT </span></h4>
                    <div class="form-group" id="selector">
                        <select id="selectBox" class="form-control">
                            <option value="">Select Flight</option>
                        </select>
                        <br>
                        <input type="text" id="flightnumber" name="" value="" readonly="readonly" placeholder="None Selected" class="form-control">
                        <br>
                        <div class="col-lg-12"><button class="btn btn-primary" onclick="sendToBackend()">Speak As Pilot</button></div>
                        <input type="hidden" value="" id="iata">
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    ...
                    <h5 style="text-align: left;"><img src="images/airplane/N copy.png" style="height: 17px;width: auto;"><span style="color: lightblue; font-size: 8px;"> : UNDER APPROACH CONTROL</span></h5>
                    <h5 style="text-align: left;"><img src="images/airplane/yellow/N copy.png" style="height: 17px;width: auto;"><span style="color: lightblue; font-size: 8px;"> : UNDER TOWER / BASE CONTROL</span></h5>
                    <h5 style="text-align: left;"><img src="apt1.png" style="height: 17px;width: auto;"><span style="color: lightblue; font-size: 8px;">  : AIRPORTS</span></h5>
                </div>
                ...
                <div style="margin-top: -10px">
                    <img src="images/logo.png" style="height:auto;width: 190px">
        ...
        <div class="main">
            <div id="map">
                ...
                <br>
                <br>
                <p style="text-align:center;"><img src="images/AATCnew transparent.png" style="height: 180px;width: auto;"></p>
                <br>
                <br>
